...
(function() {
    ...
    const TEXTS = {
        zh: {
            title: 'Huxulm 的 AI 助理',
            placeholder: '有什么可以帮您的吗？',
            welcome: '您好！我是 Huxulm 的 AI 助理，可以帮您了解 Huxulm 的技术见解和经验分享。有什么想了解的吗？',
            sources: '参考资料',
        ...
        en: {
            title: 'Huxulm\'s AI Assistant',
            placeholder: 'What can I help you with?',
            welcome: 'Hello! I\'m Huxulm\'s AI assistant. I can help you explore Huxulm\'s technical insights and experience. What would you like to know?',
            sources: 'References',
    ...
    title.textContent = 'Ask Huxulm';
    
    // Slogan below the title
    const slogan = document.createElement('div');
    slogan.className = 'ai-chatbot-slogan';
    slogan.textContent = 'Talk to Huxulm’s digital self';
